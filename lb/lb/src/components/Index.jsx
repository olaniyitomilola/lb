...
export default function IndexPage(props) {
    ...
    const handleAccountReg = async (exp)=>{
        ...
        if(firstName,lastName,email,password,cpassword,language,expertise){
            ...
            const req = await Post('/user/register',body);
            console.log(req)
            if(req.success){
